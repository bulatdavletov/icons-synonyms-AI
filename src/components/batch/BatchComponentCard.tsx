...
export function BatchComponentCard({ 
  component,
  ...
  const { id, name, type, description, hasDescription, synonyms: generatedSynonyms = [], isLoading, isError, errorMessage, isEdited } = component
      ...
      <Stack space="small">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            {/* Show checkmark for edited components */}
            {isEdited && (
              <IconLibrary16 style={{ color: 'var(--figma-color-icon-success)' }} />
            )}
          </div>
